...
\item 
void \hyperlink{main_8cc_afd34c13fc4f409851ffc0989c13dd287}{Draw} (const std\+::shared\+\_\+ptr$<$ S\+D\+L\+\_\+\+Window $>$ window, const std\+::shared\+\_\+ptr$<$ \hyperlink{classGameWorld}{Game\+World} $>$ game\+\_\+world)
\item 
...
\begin{DoxyCode}
37                                                                                              \{
38   glClearColor(0.204f, 0.255f, 0.51f, 1.0f);
...
\begin{DoxyCode}
140                                  \{
141   Uint32 delay = 1000/30; \textcolor{comment}{// in milliseconds}
142 
...
146   \textcolor{keywordflow}{if}(!window) \{
147     SDL\_Quit();
148   \}
149 
150   \textcolor{comment}{// Call the function "tick" every delay milliseconds}
151   SDL\_AddTimer(delay, \hyperlink{main_8cc_a70eaa727262f633037c3f4b7d3ff24c2}{tick}, NULL);
152 
153   \textcolor{comment}{// Add the main event loop}
154   SDL\_Event event;
155   \textcolor{keywordflow}{while} (SDL\_WaitEvent(&event)) \{
156     \textcolor{keywordflow}{switch} (event.type) \{
157     \textcolor{keywordflow}{case} SDL\_QUIT:
158       SDL\_Quit();
159       \textcolor{keywordflow}{break};
160     \textcolor{keywordflow}{case} SDL\_USEREVENT:
161       \hyperlink{main_8cc_afd34c13fc4f409851ffc0989c13dd287}{Draw}(window, game\_world);
162 
