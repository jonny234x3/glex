...
CubeAsset::CubeAsset(glm::vec3 Spawn, glm::vec3 xyzPos/*GLfloat x, GLfloat y, GLfloat z*/) : GameAsset(Spawn, xyzPos/*x, y, z*/) {
...
void CubeAsset::checkError(std::string file, int line) {
