...
void Game::Draw(const std::shared_ptr<SDL_Window> &window, const std::shared_ptr<GameWorld> &game_world) {
  glClearColor(0.204f, 0.255f, 0.51f, 1.0f);
...
std::shared_ptr<SDL_Window> Game::InitWorld() {
  Uint32 width = 640;
  Uint32 height = 480;
  SDL_Window * _window;
